 ...
 * Document Type.
 */
object NatCertRevokedSigEcdsa {
    const val NATCERT_REVOKED_ECDSA_DOCTYPE = "org.iso.18013.5.1.natcertrevokedecdsa"
    const val NATCERT_REVOKED_ECDSA_NAMESPACE = "org.iso.18013.5.1.natcertrevokedecdsa"

    /**
     * Build the Driving License Document Type.
     */
    fun getDocumentType(): DocumentType {
        return DocumentType.Builder("Certificate of Naturalization (Revoked Ecdsa)")
            .addMdocDocumentType(NATCERT_REVOKED_ECDSA_DOCTYPE)
            ...
            .addAttribute(
                ...
                SampleData.NAT_CERT_REVOKED_SIG_ECDSA.toDataItem()
            )
            /*
            ...
            .addVcAttribute(
                ...
                "Certificate of Naturalization",
                "Certificate of Naturalization (Revoked ECDSA)",
                Icon.ACCOUNT_BALANCE,
                "test".toDataItem()
            )
            .build()
