 ...
 * Document Type.
 */
object NatCertBadSigEcdsa {
    const val NATCERT_BAD_ECDSA_DOCTYPE = "org.iso.18013.5.1.natcertbadecdsa"
    const val NATCERT_BAD_ECDSA_NAMESPACE = "org.iso.18013.5.1.natcertbadecdsa"

    /**
     * Build the Driving License Document Type.
     */
    fun getDocumentType(): DocumentType {
        return DocumentType.Builder("Certificate of Naturalization (Bad ECDSA)")
            .addMdocDocumentType(NATCERT_BAD_ECDSA_DOCTYPE)
            ...
            .addVcAttribute(
                ...
                "Certificate of Naturalization",
                "Certificate of Naturalization (Bad ECDSA)",
                Icon.ACCOUNT_BALANCE,
                "test".toDataItem()
            )
            .build()
