 ...
 * Document Type.
 */
object NatCertGoodSigEcdsa {
    const val NATCERT_GOOD_ECDSA_DOCTYPE = "org.iso.18013.5.1.natcertgoodecdsa"
    const val NATCERT_GOOD_ECDSA_NAMESPACE = "org.iso.18013.5.1.natcertgoodecdsa"

    /**
     * Build the Driving License Document Type.
     */
    fun getDocumentType(): DocumentType {
        return DocumentType.Builder("Certificate of Naturalization (Good Ecdsa)")
            .addMdocDocumentType(NATCERT_GOOD_ECDSA_DOCTYPE)
            ...
            .addAttribute(
                ...
                SampleData.NAT_CERT_GOOD_SIG_ECDSA.toDataItem()
            )
            /*
            ...
            .addVcAttribute(
                ...
                "Certificate of Naturalization",
                "Certificate of Naturalization (Good ECDSA)",
                Icon.ACCOUNT_BALANCE,
                "test".toDataItem()
            )
            .build()
